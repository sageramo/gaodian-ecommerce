...
const FilterSidebar = () => {
  ...
  /**
   * Handle heritage type filter change
   */
  const handleHeritageTypeChange = (e) => {
  ...
  // Heritage type options
  const heritageTypeOptions = [
    { label: t('filter.all'), value: 'all' },
    { label: t('heritage.mahjong'), value: HeritageType.MAHJONG },
    { label: t('heritage.go'), value: HeritageType.GO },
    { label: t('heritage.chess'), value: HeritageType.CHESS },
    { label: t('heritage.dominoes'), value: HeritageType.DOMINOES },
  ];
    ...
    <div className="filter-sidebar">
      ...
      >
        ...
        <div className="filter-section">
          <h4 className="filter-section-title">{t('filter.type')}</h4>
          <Radio.Group
            value={filters.heritageType || 'all'}
